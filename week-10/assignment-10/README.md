...
Inputs are done via input() in the terminal.
A menu will appear after the program runs. Enter a valid number input according to the action you would like to perform. Any invalid numbers will continue displaying the menu, so enter the associated value to quit the program.
